...
namespace AutoLotDAL.DataSets {
    ...
    public partial class AutoLotDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_Order_ToTable_1;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_Order_ToTable_1 = this.Relations["FK_Order_ToTable_1"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_Order_ToTable_1 = new global::System.Data.DataRelation("FK_Order_ToTable_1", new global::System.Data.DataColumn[] {
                        this.tableCustumers.CustIdColumn}, new global::System.Data.DataColumn[] {
                        this.tableOrder.CustIdColumn}, false);
            this.Relations.Add(this.relationFK_Order_ToTable_1);
        }
        ...
        public partial class CustumersDataTable : global::System.Data.TypedTableBase<CustumersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustumersRow AddCustumersRow(string FirstName, string LastName) {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderRow AddOrderRow(InventoryRow parentInventoryRowByFK_Order_ToTable, CustumersRow parentCustumersRowByFK_Order_ToTable_1) {
                OrderRow rowOrderRow = ((OrderRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        null,
                        null};
                if ((parentInventoryRowByFK_Order_ToTable != null)) {
                    columnValuesArray[1] = parentInventoryRowByFK_Order_ToTable[0];
                }
                if ((parentCustumersRowByFK_Order_ToTable_1 != null)) {
                    columnValuesArray[2] = parentCustumersRowByFK_Order_ToTable_1[0];
                }
        ...
        public partial class CustumersRow : global::System.Data.DataRow {
            ...
            public string FirstName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'FirstName\' in table \'Custumers\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string LastName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'LastName\' in table \'Custumers\' is DBNull.", e);
                    }
                }
                set {
            ...
            public OrderRow[] GetOrderRows() {
                if ((this.Table.ChildRelations["FK_Order_ToTable_1"] == null)) {
                    return new OrderRow[0];
                }
                else {
                    return ((OrderRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Order_ToTable_1"])));
                }
            }
        }
        ...
        public partial class OrderRow : global::System.Data.DataRow {
            ...
            public InventoryRow InventoryRow {
                get {
                    return ((InventoryRow)(this.GetParentRow(this.Table.ParentRelations["FK_Order_ToTable"])));
                }
                set {
            ...
            public CustumersRow CustumersRow {
                get {
                    return ((CustumersRow)(this.GetParentRow(this.Table.ParentRelations["FK_Order_ToTable_1"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_Order_ToTable_1"]);
                }
            }
        }
...
namespace AutoLotDAL.DataSets.AutoLotDataSetTableAdapters {
    ...
    public partial class CustumersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Custumers] ([FirstName], [LastName]) VALUES (@FirstName, @Last" +
                "Name);\r\nSELECT CustId, FirstName, LastName FROM Custumers WHERE (CustId = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Custumers] SET [FirstName] = @FirstName, [LastName] = @LastName WHERE (([CustId] = @Original_CustId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
...
SELECT CarId, Make, Color, PetName FROM Inventory WHERE (CarId = @CarId)";
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Order] WHERE (([OrderId] = @Original_OrderId) AND ([CarID] = @" +
                "Original_CarID) AND ([CustId] = @Original_CustId))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([CarID], [CustId]) VALUES (@CarID, @CustId);\r\nSELECT O" +
                "rderId, CarID, CustId FROM [Order] WHERE (OrderId = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Order] SET [CarID] = @CarID, [CustId] = @CustId WHERE (([OrderId] =" +
                " @Original_OrderId) AND ([CarID] = @Original_CarID) AND ([CustId] = @Original_Cu" +
                "stId));\r\nSELECT OrderId, CarID, CustId FROM [Order] WHERE (OrderId = @OrderId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT OrderId, CarID, CustId FROM dbo.[Order]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_OrderId, int Original_CarID, int Original_CustId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int CarID, int CustId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CarID, int CustId, int Original_OrderId, int Original_CarID, int Original_CustId, int OrderId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CarID, int CustId, int Original_OrderId, int Original_CarID, int Original_CustId) {
            return this.Update(CarID, CustId, Original_OrderId, Original_CarID, Original_CustId, Original_OrderId);
        }
    }
